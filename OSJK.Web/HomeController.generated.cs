...
namespace OSJK.Web.Controllers
{
    public partial class HomeController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string About = "About";
                public readonly string CompanyPage = "CompanyPage";
                public readonly string Contact = "Contact";
                public readonly string Index = "Index";
            }
            public readonly string About = "~/Views/Home/About.cshtml";
            public readonly string CompanyPage = "~/Views/Home/CompanyPage.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : OSJK.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void SendEmailOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, OSJK.Web.Models.EmailFormVM vm);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> SendEmail(OSJK.Web.Models.EmailFormVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.SendEmail);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
            SendEmailOverride(callInfo, vm);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
